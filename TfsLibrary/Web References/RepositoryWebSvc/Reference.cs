...
namespace CodePlex.TfsLibrary.RepositoryWebSvc {
    ...
    public partial class Repository : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://schemas.microsoft.com/TeamFoundation/2005/06/VersionControl/ClientServices" +
            ...
            "/03", ResponseNamespace="http://schemas.microsoft.com/TeamFoundation/2005/06/VersionControl/ClientServices" +
            "/03", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public GetOperation[] Merge(string workspaceName, string workspaceOwner, ItemSpec source, ItemSpec target, VersionSpec from, VersionSpec to, MergeOptions options, LockLevel lockLevel, out Failure[] failures, out Conflict[] conflicts) {
        ...
        /// <remarks/>
        public void MergeAsync(string workspaceName, string workspaceOwner, ItemSpec source, ItemSpec target, VersionSpec from, VersionSpec to, MergeOptions options, LockLevel lockLevel) {
            this.MergeAsync(workspaceName, workspaceOwner, source, target, from, to, options, lockLevel, null);
        }
        
        /// <remarks/>
        public void MergeAsync(string workspaceName, string workspaceOwner, ItemSpec source, ItemSpec target, VersionSpec from, VersionSpec to, MergeOptions options, LockLevel lockLevel, object userState) {
            ...
            this.InvokeAsync("Merge", new object[] {
                        ...
                        to,
                        options,
                        lockLevel}, this.MergeOperationCompleted, userState);
        }
        ...
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://schemas.microsoft.com/TeamFoundation/2005/06/VersionControl/ClientServices" +
            ...
            "/03", ResponseNamespace="http://schemas.microsoft.com/TeamFoundation/2005/06/VersionControl/ClientServices" +
            "/03", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public GetOperation[] PendChanges(string workspaceName, string ownerName, ChangeRequest[] changes, out Failure[] failures) {
        ...
        /// <remarks/>
        public void PendChangesAsync(string workspaceName, string ownerName, ChangeRequest[] changes) {
            this.PendChangesAsync(workspaceName, ownerName, changes, null);
        }
        
        /// <remarks/>
        public void PendChangesAsync(string workspaceName, string ownerName, ChangeRequest[] changes, object userState) {
            ...
            this.InvokeAsync("PendChanges", new object[] {
                        workspaceName,
                        ownerName,
                        changes}, this.PendChangesOperationCompleted, userState);
        }
