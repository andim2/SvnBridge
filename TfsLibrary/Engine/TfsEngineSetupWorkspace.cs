                                              ...
                                              bool includePendingEdits)
        {
            ...
            while (true)
            {
                try
                {
                    ...
                    sourceControlService.AddWorkspaceMapping(tfsUrl, credentials, workspace.Name, serverPath, localPath);
                    ...
                    if (includePendingEdits && pendRequests.Count > 0)
                        sourceControlService.PendChanges(tfsUrl, credentials, workspace.Name, pendRequests);
