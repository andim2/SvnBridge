    ...
    public partial class TfsEngine
    {
                          ...
                          SourceItemCallback callback)
        {
            ...
            using (TfsWorkspace workspace = SetupWorkspace(directory, true))
            {
                ...
                Commit_GetAddItemIds(commitList, directory, folderInfo);
                                 ...
                                 string workspaceName)
        {
            ...
            return sourceControlService.Commit(folderInfo.TfsUrl, credentials, workspaceName, message, commitServerList);
        }
