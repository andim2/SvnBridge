...
namespace CodePlex.TfsLibrary.ClientEngine
{
    public partial class TfsEngine
    {
                                         ...
                                         int options)
        {
            ...
            SourceItem[] serverItems = QueryItems(folderInfo.TfsUrl, serverItemPath, RecursionType.None, version, sortAscending, options);
                                   ...
                                   SourceItemCallback callback)
        {
            ...
            SourceItem item = GetCombinedSourceItem(filename, VersionSpec.Latest, false, 0);
                                     ...
                                     SourceItemCallback callback)
        {
            ...
            foreach (SourceItem i in GetCombinedSourceItems(directory, VersionSpec.Latest, recursive, false, 0))
