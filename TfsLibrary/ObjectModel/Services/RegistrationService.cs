...
namespace CodePlex.TfsLibrary.ObjectModel
{
    ...
    {
        static readonly Dictionary<string, RegistrationEntry[]> entriesCache = new Dictionary<string, RegistrationEntry[]>();
                                             ...
                                             string interfaceName)
        {
            ...
            lock (entriesCache)
            {
                ...
                {
                    IRegistrationWebSvc registrationWebSvc = registrationWebSvcFactory.Create(tfsUrl, credentials);
